...
NAME_TABLE = "usbonds"  # This can be changed as needed
SrVAR_DIR = "SrVAR"
VARNN_DIR = "VARNN"
DATE_COLUMN = "date"
ID_COLUMN = "id"
...
def merge_prediction_data(date_df: DataFrame, srvar_df: DataFrame, varnn_df: DataFrame) -> DataFrame:
...
def main():
    ...
    try:
        ...
        # Define file paths
        srvar_file_path = f"{CSV_BASE_DIR}/{SrVAR_DIR}/{NAME_TABLE}_SrVAR_predict.csv"
        varnn_file_path = f"{CSV_BASE_DIR}/{VARNN_DIR}/{NAME_TABLE}_VARNN_predict.csv"
        ...
        final_df = merge_prediction_data(date_df, srvar_df, varnn_df)
        ...
        target_table = f"{TARGET_NAMESPACE}.{NAME_TABLE}_future"
