...
logger = logging.getLogger("SilverToGold_GoldBonds")
...
TARGET_TABLE = f"{TARGET_NAMESPACE}.usbonds"
DATE_COLUMN = "date"
PRICE_COLUMN = "price" 
ID_COLUMN = "id"
...
def main():
    ...
    try:
        # Initialize Spark
        spark = create_spark_session("Silver_to_Gold_GoldBonds_ETL")
        
        # Ensure target namespace exists
        create_namespace_if_not_exists(spark, TARGET_NAMESPACE)
        
        # Define tables to process
        tables_to_join = ['gold', 'us_2_year_bond', 'us_3_month_bond', 'us_5_year_bond', 'us_10_year_bond']
